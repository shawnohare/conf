#  Common system configuration settings for macbook
#
#  flake.nix
#   └─ ./macos
#       ├─ ./default.nix
...
{ config, pkgs, user, home-manager, location, ... }:
{

  # If not set home will default to /var/empty, causing build errors.
  users.users.${user} = {
    home = "/Users/${user}";
    shell = pkgs.zsh;
  };
  ...
  system = {
    ...
    # Should we use package zsh or system zsh?
